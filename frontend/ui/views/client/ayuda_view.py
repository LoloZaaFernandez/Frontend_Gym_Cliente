"""
Vista de Ayuda y Soporte para Clientes - Información de contacto del equipo
"""
...
def show_ayuda_cliente_view(page: ft.Page, auth_service, on_section_click, current_section):
    """
    Vista de ayuda con información de contacto del equipo de desarrollo para clientes
    """
    ...
    user_info = {"nombre": current_user.get("nombre", "Usuario"), "rol": "Cliente"}
